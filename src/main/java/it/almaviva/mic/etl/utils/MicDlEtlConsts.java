...
public class MicDlEtlConsts 
{
	...
	public static final String PROPRIETARIO_HIST_STAGING = "sql/proprietario_hist_staging_insert.sql";
	public static final String PROPRIETARIO_HIST_STAGING_INSERT = "sql/proprietario_hist_staging.sql";
