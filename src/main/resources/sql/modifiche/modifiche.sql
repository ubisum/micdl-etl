...
CREATE TABLE `ade_titolarita_hist` (
  ...
  `id_imm_catasto` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `soggetto_riferimento` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `conc_cd_causale_atto_generante` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conc_descrizione_atto_generante` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conc_cd_causale_atto_conclusivo` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
